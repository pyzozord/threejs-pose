...
export const CSS3DObject = function ( element ) {
...
export const CSS3DSprite = function ( element ) {
...
export const CSS3DRenderer = function () {
  console.log( 'CSS3DRenderer', Three.REVISION )
  var _width, _height
